...
export default function BannerSettings() {
  ...
  const bannerEditorSetting = (key) => {
    ...
    const titleBody =
      "primary" === key
        ? __("Primary Banner", "brandy")
        : __("Secondary Banner", "brandy");
    return (
      <>
        <PanelBody title={titleBody}>
          ...
          {banner.imageURL && (
            <div className="brandy-banner-image-container">
              <img
                src={banner.imageURL}
                alt={__("Upload an Image", "brandy")}
              />
              <a
                href="#"
                className="brandy-remove-image-button"
                onClick={() => doRemoveBannerImage(key)}
              >
                {__("Remove Image", "brandy")}
              </a>
            </div>
          )}
          <div className="products-with-banners-banner-content-wrapper">
            <TextControl
  ...
  return (
    <>
      <div className="products-with-banners-banner-wrapper products-with-banners-primary-banner-settings">
        {bannerEditorSetting("primary")}
      </div>
      <div className="products-with-banners-banner-wrapper products-with-banners-secondary-banner-settings">
