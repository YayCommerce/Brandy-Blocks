...
export default function Edit({ attributes, setAttributes, clientId }) {
  ...
  const {visible,color,typography,margin} = parentAttributes.content;

  const handleChangeValueToParent = (key) => (value) => {
    if (key in parentAttributes.content) {
      const newAttributes = {
        ...parentAttributes,
        content: {
          ...parentAttributes.content,
          [key]: value
        }
      };
  ...
  return (
    <>
      <InspectorControls key="setting">
        <div className="brandy-editor-testimonial-content">
            <div className="brandy-editor-testimonial-content__options brandy-editor-testimonial-content__options__visible">
           ...
           <div className="brandy-editor-testimonial-content__options brandy-editor-testimonial-content__options__color"> 
                <PanelColorSettings
           ...
           <div className="brandy-editor-testimonial-content__options brandy-editor-testimonial-content__options__typography"> 
           ...
           <div className="brandy-editor-testimonial-content__options brandy-editor-testimonial-content__options__margin"> 
