    ...
    return (
        <InspectorControls>
            <PanelBody title={__("Original Price", "brandy-blocks")} className='brandy-original-price-settings-panel'>
                <PanelColorSettings
                    className='brandy-original-price-color-settings'
                    title={__('Color', "brandy-blocks")}
                    initialOpen={false}
                    colorSettings={[
                        {
                            value: typography.color,
                            onChange: (newColor) =>
                                setAttributes({ originalPriceTypography: { ...typography, color: newColor } }),
                ...
                <Spacer>
                    <FontSizePicker
                        ...
                        onChange={(newFontSize) => setAttributes({ originalPriceTypography: { ...typography, fontSize: newFontSize } })}
                ...
                <Spacer>
                    <CustomSelectControl
                        ...
                        onChange={({ selectedItem }) => setAttributes({ originalPriceTypography: { ...typography, appearance: selectedItem } })}
